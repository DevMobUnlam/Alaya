            ...
            if (currentRoute !in listOf("nobottom", "nobottom2")) {
                BottomBarNavigation(
                    items = listOf(
                        ...
                        ItemMenu(
                            iconType = IconType.PROFESSIONAL,
                            route = NavUtils.ProfessionalRoutes.Home.route,
                            contentDescription = "Home profesional",
                            order = 2
                        ),
                        ItemMenu(
                            iconType = IconType.HOME,
                            route = NavUtils.PatientRoutes.Home.route,
                            contentDescription = "boton de inicio",
                            order = 1
                        ),
                    ),
